...
| Environments      | The `pypi` environment requires `Hermione-Granger-1176` as a reviewer, keeps administrator bypass enabled for the sole maintainer, and does not prevent self-review                                                                                                                                                                                                                                                   |
