...
| Where                                                          | Owns                                                                                                                                                                             |
| -------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<defs>` in `web/index.html`                                   | The shared `#pipWobble` ink filter, one `<g id="pip-...">` per pose used more than once, and the hands more than one pose is built from                                          |
