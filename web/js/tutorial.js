...
const Tutorial = (() => {
    ...
    function handleDotClick(event) {
        ...
        const dot = event.target.closest('.tutorial-dot[data-step-index]');
        if (!dot) {
            return;
        }
    ...
    function handleRestartClick(event) {
        const trigger = event.target.closest('[data-tutorial-action="restart"], .tutorial-restart-btn[data-tutorial-route]');
        if (!trigger) {
            return;
        }
    ...
    function resolveRestartRoute(trigger) {
        ...
        if (typeof ScreenManager !== 'undefined' && typeof ScreenManager.getCurrentRouteName === 'function') {
        ...
        if (typeof AppRouter !== 'undefined' && typeof AppRouter.getCurrentRoute === 'function') {
