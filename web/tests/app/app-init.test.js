...
import { ScreenManager } from "../../src/app/screen-manager.js";
import { Tutorial } from "../../src/features/tutorial/tutorial.js";
import {
    disableTelemetry,
    initSentry,
    setTelemetryConsent,
    telemetryConsentGranted,
} from "../../src/platform/observability/sentry.js";
import { initTelemetry } from "../../src/platform/observability/telemetry.js";
import { Session } from "../../src/platform/persistence/session.js";
...
vi.mock("../../src/app/screen-manager.js", () => ({
...
describe("app init wiring", () => {
    ...
    it("captures session cleanup failures without blocking bootstrap", async () => {
        ...
        const sentry = await import("../../src/platform/observability/sentry.js");
