...
vi.mock("../../../src/features/tutorial/steps.js", () => ({
    TutorialSteps: {
        home: [
            {
                id: "home-step-1",
...
beforeEach(async () => {
    ...
    ({ Tutorial } = await import("../../../src/features/tutorial/tutorial.js"));
});
...
describe("restart button", () => {
    ...
    it("uses ScreenManager route when data-tutorial-route is absent", async () => {
        const { ScreenManager } = await import("../../../src/app/screen-manager.js");
    ...
    it("uses AppRouter route when ScreenManager returns empty", async () => {
        const { ScreenManager } = await import("../../../src/app/screen-manager.js");
        const { AppRouter } = await import("../../../src/app/router.js");
