...
async function enableSentry({ environment = "test", release = "release-test" } = {}) {
    ...
    const api = await import("../../../src/platform/observability/sentry.js");
...
describe("sentry", () => {
    ...
    it("keeps telemetry disabled without both a DSN and explicit consent", async () => {
        const sentry = await import("@sentry/browser");
        const { captureError, captureMetric, initSentry } = await import("../../../src/platform/observability/sentry.js");
    ...
    it("stores and revokes telemetry consent", async () => {
        const { setTelemetryConsent, telemetryConsentGranted } = await import("../../../src/platform/observability/sentry.js");
