...
describe("telemetry", () => {
    ...
    it("initializes web-vitals reporters once", async () => {
        ...
        const { initTelemetry } = await import("../../../src/platform/observability/telemetry.js");
    ...
    it("reports measured durations with perf prefix", async () => {
        const sentry = await import("../../../src/platform/observability/sentry.js");
        const { reportPerformanceMeasure } = await import("../../../src/platform/observability/telemetry.js");
