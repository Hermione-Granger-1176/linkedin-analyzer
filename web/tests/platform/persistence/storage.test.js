...
describe("Storage", () => {
    ...
    describe("in-memory fallback when IndexedDB cannot open", () => {
        it("degrades to memory and notifies listeners after an open failure", async () => {
            vi.resetModules();
            const { Storage: MemStorage } = await import("../../../src/platform/persistence/storage.js");
    ...
    describe("v2 to v3 migration", () => {
        it("moves inline CSV text into the text store on upgrade", async () => {
            ...
            vi.resetModules();
            const { Storage: MigratedStorage } = await import("../../../src/platform/persistence/storage.js");
