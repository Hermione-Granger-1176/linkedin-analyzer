...
describe("worker contracts", () => {
    ...
    it("rejects invalid analytics request envelopes and oversize payloads", () => {
        ...
        const invalidAddFilePayload = parseAnalyticsWorkerRequest({
            type: "addFile",
            payload: null,
        });
    ...
    it("normalizes connections worker message fallbacks", () => {
        ...
        const processedFromInvalidPayload = parseConnectionsWorkerMessage({
            type: "processed",
            payload: null,
        });
    ...
    it("rejects invalid connections worker request envelopes and oversize payloads", () => {
        ...
        const missingPayloadDefaults = parseConnectionsWorkerRequest({
            type: "process",
            payload: null,
        });
